...
function CartComponent_div_4_mat_card_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "mat-card", 16)(1, "mat-card-title");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "mat-card-content")(4, "p");
    \u0275\u0275text(5);
    \u0275\u0275pipe(6, "currency");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "p");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "mat-card-actions")(10, "button", 17);
    \u0275\u0275listener("click", function CartComponent_div_4_mat_card_1_Template_button_click_10_listener() {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("\xC1r: ", \u0275\u0275pipeBind2(6, 3, item_r3.price, "HUF"), "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Mennyis\xE9g: ", item_r3.quantity, "");
  }
}
function CartComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, CartComponent_div_4_mat_card_1_Template, 13, 6, "mat-card", 6);
    \u0275\u0275element(2, "mat-divider", 7);
    \u0275\u0275elementStart(3, "form", 8, 1);
    \u0275\u0275listener("ngSubmit", function CartComponent_div_4_Template_form_ngSubmit_3_listener() {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function CartComponent_div_4_Template_input_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.orderData.name, $event) || (ctx_r3.orderData.name = $event);
    ...
    \u0275\u0275twoWayListener("ngModelChange", function CartComponent_div_4_Template_input_ngModelChange_12_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.orderData.email, $event) || (ctx_r3.orderData.email = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "mat-form-field", 9)(14, "mat-label");
    \u0275\u0275text(15, "Sz\xE1ll\xEDt\xE1si c\xEDm");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "textarea", 12);
    \u0275\u0275twoWayListener("ngModelChange", function CartComponent_div_4_Template_textarea_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.orderData.address, $event) || (ctx_r3.orderData.address = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "mat-form-field", 9)(18, "mat-label");
    \u0275\u0275text(19, "Telefonsz\xE1m");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "input", 13);
    \u0275\u0275twoWayListener("ngModelChange", function CartComponent_div_4_Template_input_ngModelChange_20_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r3.orderData.phone, $event) || (ctx_r3.orderData.phone = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(26, " Megrendel\xE9s lead\xE1sa ");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const orderForm_r5 = \u0275\u0275reference(4);
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r3.cartItems);
    \u0275\u0275advance(7);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.orderData.name);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.orderData.email);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.orderData.address);
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r3.orderData.phone);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("V\xE9g\xF6sszeg: ", \u0275\u0275pipeBind2(24, 7, ctx_r3.getTotal(), "HUF"), "");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !orderForm_r5.form.valid);
  }
}
function CartComponent_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 18);
    \u0275\u0275text(1, "A kosarad \xFCres.");
    \u0275\u0275elementEnd();
  }
}
var CartComponent = class _CartComponent {
  ...
  constructor(auth, db, cartService, snackBar) {
    this.auth = auth;
    this.db = db;
  ...
  checkout() {
    return __async(this, null, function* () {
      ...
      if (!user) {
        this.snackBar.open("Be kell jelentkezni a rendel\xE9shez.", "OK", { duration: 3e3 });
        return;
      }
      const uid = user.uid;
      ...
      try {
        yield set(newOrderRef, orderToSave);
        this.snackBar.open("Rendel\xE9s sikeresen leadva!", "OK", { duration: 3e3 });
        this.cartService.clearCart();
        this.orderData = { name: "", email: "", address: "", phone: "" };
      } catch (error) {
        this.snackBar.open("Hiba t\xF6rt\xE9nt a rendel\xE9s ment\xE9sekor.", "OK", { duration: 3e3 });
      }
    });
  }
  static \u0275fac = function CartComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CartComponent)(\u0275\u0275directiveInject(Auth), \u0275\u0275directiveInject(Database), \u0275\u0275directiveInject(CartService), \u0275\u0275directiveInject(MatSnackBar));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartComponent, selectors: [["app-cart"]], decls: 7, vars: 2, consts: [["emptyCart", ""], ["orderForm", "ngForm"], [1, "cart-container"], [1, "title"], [1, "mb-4"], [4, "ngIf", "ngIfElse"], ["class", "product-card", 4, "ngFor", "ngForOf"], [1, "my-4"], [1, "order-form", 3, "ngSubmit"], ["appearance", "outline"], ["matInput", "", "required", "", "name", "name", 3, "ngModelChange", "ngModel"], ["matInput", "", "required", "", "type", "email", "name", "email", 3, "ngModelChange", "ngModel"], ["matInput", "", "required", "", "name", "address", 3, "ngModelChange", "ngModel"], ["matInput", "", "required", "", "type", "tel", "name", "phone", 3, "ngModelChange", "ngModel"], [1, "order-summary"], ["mat-raised-button", "", "color", "primary", "type", "submit", 3, "disabled"], [1, "product-card"], ["mat-icon-button", "", "color", "warn", 3, "click"], [1, "empty-message"]], template: function CartComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 2)(1, "h2", 3);
      \u0275\u0275text(2, "\u{1F6D2} Kos\xE1r tartalma");
      \u0275\u0275elementEnd();
      \u0275\u0275element(3, "mat-divider", 4);
      \u0275\u0275template(4, CartComponent_div_4_Template, 27, 10, "div", 5)(5, CartComponent_ng_template_5_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      const emptyCart_r6 = \u0275\u0275reference(6);
      \u0275\u0275advance(4);
      \u0275\u0275property("ngIf", ctx.cartItems.length > 0)("ngIfElse", emptyCart_r6);
    }
  }, dependencies: [CommonModule, NgForOf, NgIf, CurrencyPipe, FormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, RequiredValidator, NgModel, NgForm, MatCardModule, MatCard, MatCardActions, MatCardContent, MatCardTitle, MatButtonModule, MatButton, MatIconButton, MatIconModule, MatIcon, MatDividerModule, MatDivider, MatFormFieldModule, MatFormField, MatLabel, MatInputModule, MatInput, MatSnackBarModule], styles: ["\n\n[_nghost-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 2rem;\n}\n.title[_ngcontent-%COMP%] {\n  text-align: center;\n  margin-bottom: 1.5rem;\n  font-weight: 600;\n  font-size: 1.8rem;\n  color: #2c2c2c;\n}\n.product-card[_ngcontent-%COMP%] {\n  width: 100%;\n  max-width: 600px;\n  margin-bottom: 1.5rem;\n  background-color: #2c9e58;\n  border-radius: 10px;\n  box-shadow: 0 1px 4px rgba(0, 0, 0, 0.08);\n  padding: 1rem;\n}\n.order-form[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 1.5rem;\n  width: 100%;\n  max-width: 600px;\n  background-color: #ffffff;\n  border-radius: 12px;\n  box-shadow: 0 2px 12px rgba(0, 0, 0, 0.08);\n  padding: 2rem;\n  margin-top: 2rem;\n  text-align: center;\n}\n.order-summary[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n  align-items: center;\n  justify-content: center;\n  margin-top: 1rem;\n  font-weight: 500;\n  font-size: 1.2rem;\n  color: #1a1a1a;\n}\n.mat-form-field[_ngcontent-%COMP%] {\n  width: 100%;\n  text-align: left;\n}\n  .mat-form-field-appearance-outline .mat-form-field-infix input, \n  .mat-form-field-appearance-outline .mat-form-field-infix textarea {\n  color: #212121 !important;\n  background-color: #ffffff !important;\n  caret-color: #212121 !important;\n}\n  .mat-form-field-label {\n  color: #333 !important;\n}\n  .mat-input-element::placeholder {\n  color: #757575 !important;\n  opacity: 1 !important;\n}\n.empty-message[_ngcontent-%COMP%] {\n  text-align: center;\n  font-size: 1.2rem;\n  color: #666;\n  margin-top: 2rem;\n}\n/*# sourceMappingURL=cart.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CartComponent, { className: "CartComponent", filePath: "src/app/components/cart/cart.component.ts", lineNumber: 34 });
})();
export {
  CartComponent
};
//# sourceMappingURL=chunk-OSZBLA2V.js.map
